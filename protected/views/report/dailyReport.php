...
<div class="alert alert-warning">
	...
	<h4><?php echo Yii::t('contentForm','CHECKOUT'); ?></h4>
...
<div class="alert alert-danger">
	...
	<h4><?php echo Yii::t('contentForm','Cleaning'); ?></h4>
	
	<?php
		echo '<table class="table_dailyReport" style="width: 100%;">';
		echo '<tr>';
		echo '<td><h5>'.Yii::t('contentForm','Details').'</h5></td>';
		echo '</tr>';
		
		foreach($dataCheckOut as $checkOut)
		{
			echo '<tr>';
			echo '<td>'.$checkOut[3] . ' ' . Yii::t('contentForm','bed(s) in room') . ' '.$checkOut[2] .'</td>';
			echo '</tr>';		
		}
