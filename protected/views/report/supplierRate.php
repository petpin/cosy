<?php $this->breadcrumbs=array(
	Yii::t('contentForm','REPORT')=>array('supplierRate'),
	Yii::t('contentForm','SUPPLIER_RATE'),
);

Yii::app()->clientScript->registerCoreScript('jquery'); 
$ourscript = 'function redirect() { parent.location = \'index.php?r=report/supplierRate&year=\' + $(\'#year\').val(); }';
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
    ...
    'icon'=>'backward white',
    'url'=>Yii::app()->createUrl("report/supplierRate", array('year'=>($year-1))),
)); ?>
</div>
...
<script type="text/javascript">
	...
	function drawChart() {
		...
		var chart = new google.visualization.LineChart(document.getElementById('chart_div')).draw(data, {lineType: "function",
			title:<?php echo json_encode(Yii::t('contentForm','YEAR_AMOUNT_OF_PAID_RATES_BY_SUPPLIER')); ?>, vAxis: {maxValue: 10}
		});
    ...
    function drawPieChart() {
        ...
        // Set chart options
        var options = {'title':<?php echo json_encode(Yii::t('contentForm','YEAR_AMOUNT_OF_PAID_RATES_BY_SUPPLIER')); ?>, 'width':540, 'height':300};
