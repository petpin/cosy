...
<div class="alert alert-success" style="width: 15%; float: left;">
	...
	<h4><?php echo Yii::t('contentForm','SOLD_BEDS'); ?></h4> <?php echo $totalFaturadoSemRate; ?> €
	<h4><?php echo Yii::t('contentForm','AVERAGE_BED_RATE'); ?></h4> <?php echo $averageBedRate; ?> €
	<h4><?php echo Yii::t('contentForm','BED_OCUPANCY_TAX'); ?></h4> <?php echo $bedOccupancyTaxYear; ?> %
</div>
