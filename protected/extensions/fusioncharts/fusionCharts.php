...
class fusionCharts extends CApplicationComponent
{
	 ...
	 *
	 * @param $options array of the chart attribute options
	 ...
	 * For the full list of available key value pairs.
	 * 
	 * @param $options array of the category attribute options
	 * @return fustionCharts object
	 */
	 ...
	 * 
	 * @param $string Add custom string to the xml data
	 * @return void
	 */
	 ...
	 * 
	 * @param $options array of key=>value pairs to add to the options of the xml attribute
	 * @return fustionCharts object
	 */
	 ...
	 * 
	 * @param $rows array of category elements
	 * @return fustionCharts object
	 */
	 ...
	 * 
	 * @param $rows array of set elements
	 * @return fustionCharts object
	 */
	...
	/**
	 * @param $message set the chart message
	 * @return fustionCharts object
	 */
	...
	/**
	 * @param $cache set if to cache or not the generated cache
	 * @return fustionCharts object
	 */
	 ...
	 * 
	 * @param $includeHeader boolean value to include the xml content type header
	 * @return XMLData as string
	 */
	public function getXMLData( $includeHeader=true )
	{
	 ...
	 * @param $strValue the string needs to be encoded
	 ...
	 * @param $params array of parameters to pass to the class method
