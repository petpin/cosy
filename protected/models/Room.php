...
class Room extends CActiveRecord
{
	...
	public function rules()
	{
        ...
        return array(
			...
			array('id, title, bed_num, id_type, roomTypeDescription', 'safe'),
        );
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'title' => Yii::t('contentForm','ROOM_TITLE'),
			'bed_num' => Yii::t('contentForm','BED_NUM'),
			'id_type' => Yii::t('contentForm','ROOM_TYPE_DESCRIPTION'),
			'Name' => Yii::t('contentForm','ROOM_NAME'),
			'Beds Number' => Yii::t('contentForm','BEDS_NUMBER'),
			'Room Type' => Yii::t('contentForm','ROOM_TYPE'),
			'Room Name' => Yii::t('contentForm','ROOM_NAME'),
			'roomTypeDescription' => Yii::t('contentForm','ROOM_TYPE_DESCRIPTION'),
			'Type' => Yii::t('contentForm','TYPE')
		);
	}
