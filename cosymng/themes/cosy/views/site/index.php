...
#searchBoxOne input.search {
	...
	color: #999;
	padding: 6px;
	background: url(http://azadcreative.com/demo/search_boxes/images/01_background.png) top left no-repeat;
	border: 1px solid #b8b8b8;
}
#searchBoxOne input.submit {
	background: url(http://azadcreative.com/demo/search_boxes/images/01_submit.png) top left no-repeat;
	width: 67px;
	height: 32px;
	border: none;
	color: #dee4ff;
...
#searchBoxOne input.submit:hover {
	background: url(http://azadcreative.com/demo/search_boxes/images/01_submit.png) bottom left no-repeat;
}
