	            	...
	            	$this->widget('bootstrap.widgets.TbButtonGroup', array(
				        ...
				        'buttons'=>array(
				            array('label'=>'', /*'icon'=>'remove white',*/ 'items'=>array(
				                ...
				                array('label'=>'View Ajax', 'url'=>'javascript:viewBooking(\'' . $idBooking[$key] . '\', \'testeAjaxView\');'),
				                array('label'=>'Edit', 'url'=>$updateUrl[$key]),
				                array('label'=>'Update Ajax', 'url'=>'javascript:updateBooking(\'' . $idBooking[$key] . '\', \'testeAjaxView\');'),
				                array('label'=>'State - ' . $stateItem[$key]),
				                array('label'=>'Client'),
	            	...
	            	$this->widget('bootstrap.widgets.TbButtonGroup', array(
				        ...
				        'buttons'=>array(
				            array('label'=>'', 'items'=>array(
				                array('label'=>'Create', 'url'=>Yii::app()->createUrl('booking/create', array('room' => $room->id, 'start_date' => $currentDate))),
				                array('label'=>'Create Ajax', 'url'=>'javascript:createBooking(\'testeAjaxView\', \'' . $room->id . '\', \'' . $currentDate . '\');'),
				            ), ),
				        ),
				    ));
