...
{
?>
	<h1>View Booking of <?php echo $guestName; ?></h1>
<?php
}
?>
...
<div class="tabbable"> <!-- Only required for left/right tabs -->
  <ul class="nav nav-tabs">
    <li<?php if(Yii::app()->session['bookingViewTab'] == 'tab1') echo ' class="active"'; ?>><a href="#tab1" data-toggle="tab">Details</a></li>
    <li<?php if(Yii::app()->session['bookingViewTab'] == 'tab2') echo ' class="active"'; ?>><a href="#tab2" data-toggle="tab">Days List</a></li>
    <li<?php if(Yii::app()->session['bookingViewTab'] == 'tab3') echo ' class="active"'; ?>><a href="#tab3" data-toggle="tab">Clients List</a></li>
    <li<?php if(Yii::app()->session['bookingViewTab'] == 'tab4') echo ' class="active"'; ?>><a href="#tab4" data-toggle="tab">Supplier Details</a></li>
    <li class="dropdown">
	    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Actions <b class="caret"></b></a>
	    <ul class="dropdown-menu">
	      <li><a href="<?php echo Yii::app()->createUrl("booking/update" . "&id=" . $model->id); ?>">Update</a></li>
	      <li><a href="<?php echo Yii::app()->createUrl("booking/delete" . "&id=" . $model->id); ?>">Delete</a></li>
	      <!--<li class="divider"></li>-->
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane<?php if(Yii::app()->session['bookingViewTab'] == 'tab2') echo ' active'; ?>" id="tab2">
      <p>
		...
		<!-- Popup Header -->
		<div class="modal-header"><h4>View Day Details</h4></div>
		<!-- Popup Content -->
		<div class="modal-body"><p>Day Details</p></div>
		<!-- Popup Footer -->
