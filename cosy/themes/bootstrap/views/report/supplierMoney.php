...
<script type="text/javascript">
	...
	function drawChart() {
		...
		var chart = new google.visualization.LineChart(document.getElementById('chart_div')).draw(data, {lineType: "function",
			title:'Year Amount of Money Earned By Supplier', vAxis: {maxValue: 10}}
		);
    ...
    function drawPieChart() {
        ...
        // Set chart options
        var options = {'title':'Year Amount of Money Earned By Supplier', 'width':540, 'height':300};
