...
<div class="view">
	...
	<b><?php echo CHtml::encode('Room'); ?>:</b>
	...
	<div style="width:49%; float:left;">
	<b><?php echo CHtml::encode('Bed Number'); ?>:</b>
	...
	<?php 
	if($data->paid == '0') 	$paidValue = '<span style="color:red;">Not Paid</span>';
	else					$paidValue = '<span style="color:green;">Paid</span>';
