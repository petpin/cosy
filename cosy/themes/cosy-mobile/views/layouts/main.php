...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US"> 
  ...
  <head profile="http://gmpg.org/xfn/11"> 
    ...
    <title><?php echo Yii::app()->name ?> - Mobile</title> 
...
<body class="home blog"> 
    ...
    <div id="wrapper"> 
      ...
      <!-- BEGIN LOGO --> 
	  <div class="head_magin">
	  </div>
      <div class="heade">
		<div id="logo" class="logo_mobile"><?php echo CHtml::encode(Yii::app()->name); ?></div>
	  </div>
		...
		if(!Yii::app()->user->isGuest)
	{
		$this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Daily Report', 'url'=>array('/report/dailyReport', 'view'=>'about')),
				array('label'=>'Reports', 'url'=>array('/report/year'), 
                              'items'=>array(
                                     array('label'=>'General', 'url'=>array('/report/year'),
									 'items'=>array(
                                                    array('label'=>'Year', 'url'=>array('/report/year')),
                                                    array('label'=>'Month', 'url'=>array('/report/month'))
													) 
									 ),
                                     array('label'=>'Supplier','url'=>array('/report/supplierBooking'), 
                                           'items'=>array(
                                                    array('label'=>'Booking', 'url'=>array('/report/supplierBooking')),
                                                    array('label'=>'Clients', 'url'=>array('/report/supplierClients')),
													array('label'=>'Money', 'url'=>array('/report/supplierMoney')),
													array('label'=>'Rates', 'url'=>array('/report/supplierRate'))
                                                )
                                            ) 
                                  )
                            ),
...
*/ ?>
    ...
    <ul id="social-media"> 
      <!--li> 
        <a href="index.php?r=/booking/admin" title="Bookings"> 
          <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/pachu_mobile_booking.jpg" alt="" / > 
        </a> 
      </li--> 
      <li> 
        <a href="index.php?r=/room/admin" title="Rooms"> 
          <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/pachu_mobile_room.jpg" alt="" /> 
        </a> 
      </li> 
      <li> 
        <a href="index.php?r=/guest/admin" title="Guests"> 
          <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/pachu_mobile_guests.jpg" alt="" /> 
        </a> 
      </li> 
        <li> 
        <a href="mailto:themes@kubasto.com" title="E-mail"> 
          <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/pachu_mobile_email.jpg" alt="" /> 
        </a> 
      </li>
      </ul> 
    <!-- END SOCIAL MEDIA --> 
    ...
    <div id="footer"> 
		...
		<a href="mailto:info@cosy.com">info@cosy.com</a> 
	  	<!--
