    ...
    <div id="menu">
        <?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Plan', 'url'=>array('/report/year', 'view'=>'about')), 
				array('label'=>'Contact', 'url'=>array('/report/month')),
				array('label'=>'BLA', 'url'=>array('/report/month')),
...
*/ ?> 
    ...
    <div id="footer"> 
      ...
      <a href="mailto:themes@kubasto.com">info@cosy.com</a> 
    </div> 
    <!-- END FOOTER --> 
