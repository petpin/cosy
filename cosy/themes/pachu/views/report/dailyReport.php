...
<div style="padding-left: 20px; padding-right: 20px;">
	...
	<?php
		...
		echo '<td class="table_dailyReport_td_title">Beds Number</td>';
		echo '<td class="table_dailyReport_td_title">Value</td>';
		echo '</tr>';
		foreach($dataCheckIn as $checkIn)
		{
			...
			echo '<td class="table_dailyReport_td">' . 
...
<div style="padding-left: 20px; padding-right: 20px;">
	...
	<?php
		...
		{
			echo '<tr>';
			echo '<td class="table_dailyReport_td">'.$checkOut[1] .'</td>';
			echo '<td class="table_dailyReport_td">'.$checkOut[2] .'</td>';
			echo '<td class="table_dailyReport_td">'.$checkOut[3].'</td>';
			echo '<td class="table_dailyReport_td">'.$checkOut[4] .'</td>';
			echo '<td class="table_dailyReport_td">' . 
