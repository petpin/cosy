...
if(!Yii::app()->user->isGuest)
{
    ...
    echo '<p>' . CHtml::link('Room View',array('site/roomView')) . '</p>';
    /* Get Rooms */
    ...
    if(count($rooms) > 0)
    {
        ...
        echo '<table id="web_slider_plan_month" class="calendar_excel">';
        echo '<tr>';
        echo '<th>ROOM</th>';
        ...
        while ( $day_num <= $days_in_month )
        {
                ...
                if($day_num_week == "Sat" or $day_num_week == "Sun")
                        echo '<th class="monthViewWeekEnd" >' . (int)$day_num . '</th>';
                else
                        echo '<th class="monthView">' . (int)$day_num . '</th>';
        ...
        foreach($rooms as $room)
        {
                ...
                while ( $day_num <= $days_in_month )
                {
                        ...
                        if($day_num_week == "Sat" or $day_num_week == "Sun")
                                echo '<td class="monthViewWeekEnd">';
                        else
                                echo '<td class="monthView">';
