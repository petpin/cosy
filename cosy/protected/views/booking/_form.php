...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row" style="float: left; padding-left: 40px;"><?php echo $form->labelEx($model,'client_email'); ?>
...
'options'=>array($id_room=>array('selected'=>'selected'))));
	...
	<div class="row" style="float: left;"><?php echo $form->labelEx($model,'start_date'); ?>
	...
	<div class="row" style="float: left; padding-left: 40px;"><?php echo $form->labelEx($model,'paid'); ?>
