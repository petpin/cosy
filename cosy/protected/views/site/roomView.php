...
if(!Yii::app()->user->isGuest)
{
	...
	if(count($rooms) > 0)
	{
            ...
            echo '</p><table id="calendar" class="calendar" border="1">';
            echo '<tr class="calendar_weekend">';
            echo '<th style="width:14%;">Monday</th>';
            echo '<th style="width:14%;">Tuesday</th>';
            echo '<th style="width:14%;">Wednesday</th>';
            echo '<th style="width:14%;">Thursday</th>';
            echo '<th style="width:14%;">Friday</th>';
            echo '<th style="width:14%;">Saturday</th>';
            echo '<th style="width:14%;">Sunday</th>';
            echo '</tr>';
            ...
            while ( $day_num <= $days_in_month )
            {
                ...
                echo '<td style="width:14%;">' . $day_num . '<br />';
