...
?>
<div class="view" style="border-bottom: 1px dotted #f7f0c1">
	...
	<b><?php echo CHtml::encode(Yii::t('contentForm','ROOM')); ?>:</b>
	...
	<div style="width:49%; float:left;">
	<b><?php echo CHtml::encode(Yii::t('contentForm','BED_NUMBER')); ?>:</b>
